            ...
            ElevatedButton(
              ...
              onPressed: () {
                if (_name != null) {
                  ...
                  musicplayer.savePlaylist(_name!, [],null); // saves playlist to shared preferences
...
class ShowPlaylist extends StatefulWidget {
  ...
  ShowPlaylist({Key? key, required this.name, required this.tracklist}) : super(key: key);
                  ...
                  return Dismissible(
                      ...
                      onDismissed: (direction) {
                        setState(() {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Track removed.")));
                        });
                      },
                      child: ListTile(
...
class TrackSelection extends StatefulWidget {
  ...
  TrackSelection({Key? key, required this.name}) : super(key: key);
