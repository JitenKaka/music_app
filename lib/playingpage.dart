...
class PlayingPageState extends State<PlayingPage> {
  ...
  void saveFavTrack(String track,  List<String> trackList) async {
                                ...
                                return Container(
                                  child: ListTile(
                                    ...
                                    onTap: () {
                                      ...
                                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Track has been added to playlist")));
                  ...
                  Container(
                    ...
                    child: musicplayer.playerState == musicplayer.PlayerState.playing ? WaveWidget(
                      config: CustomConfig(
                        ...
                        blur:MaskFilter.blur(BlurStyle.normal, 3.0)
                      ),
                      waveAmplitude: 0,
                      backgroundColor: Colors.white,
                      size: Size(
